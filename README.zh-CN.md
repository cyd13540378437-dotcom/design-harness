...
5. 如果有自己的参考图，放入：
   ...
   长期可复用产品参考放在 `docs/design/reference-library/`；色卡注册表放在 `docs/design/reference-library/assets/color-cards/`；某个任务的实际参考选择放在该 Work Item 的 `REFERENCE_SELECTION.md`。
...
本仓库的 v0.1.2-alpha 范围仍是文档型、可手动复用、可真实试运行的协议闭环。Color Card Registry 是 v0.1.1-alpha Reference Library 之上的增量，不是 v0.2。后续版本计划见 [CHANGELOG.md](CHANGELOG.md) 和 [docs/PRD.md](docs/PRD.md) 的路线图。
