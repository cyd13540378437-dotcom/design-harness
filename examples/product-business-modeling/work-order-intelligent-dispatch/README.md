...
The detailed modular assets remain under `docs/product/business-modeling/` and the canonical Work Item remains under `docs/product/business-modeling/work-items/BM-001-work-order-intelligent-dispatch/`.
