...
description: 对新产品界面、重要功能页面、跨页面用户流程和显著 UI/UX 改造执行人参与的设计工程工作流。负责识别或恢复 Work Item，执行 Surface Resolution、参考库消费、Color Card Registry 消费、Visual Seed、参考解析、配色确认、设计禁区确认、视觉原型、实现验证与完成确认，并通过 STATE.md、REFERENCE_SELECTION.md 与 VISUAL_DESIGN.md 跨 Codex 对话恢复状态。
---
