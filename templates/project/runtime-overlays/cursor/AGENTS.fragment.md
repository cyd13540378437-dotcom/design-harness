...
Use the Cursor rule and optional Skill facade for durable business-model work. Read and present `docs/product/business-modeling/BUSINESS_MODEL_OVERVIEW.md` as the default user file; detailed source of truth remains under `docs/product/business-modeling/`.
