...
Read `docs/product/business-modeling/BUSINESS_MODEL_OVERVIEW.md` first and present it as the business-model module's default user file. Detailed truth remains under `docs/product/business-modeling/`; canonical Work Items remain under `docs/product/business-modeling/work-items/`. If a project-level delivery layer exists, it may consume this overview as the business-model export.
