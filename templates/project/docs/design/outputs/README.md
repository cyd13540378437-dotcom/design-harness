...
`docs/design/outputs/` tracks design deliverables that have been produced, reviewed, or adopted as project baselines.

- `current/` contains current user-confirmed entry points or baseline candidates.
